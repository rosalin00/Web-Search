...
# FILENAME: index.py
# SPECIFICATION: This program provides a command-line menu for managing a 
# PostgreSQL database: users can create, update, delete documents and categories, 
# view the inverted index of terms within documents, or exit the application.
# FOR: CS 4250- Assignment #2
# TIME SPENT: Took me a few days to complete. S
#-----------------------------------------------------------*/
